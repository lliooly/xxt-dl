...
| `npm run release:test-version` | 准备应用内更新测试用的 beta 版本号 |
...
应用内更新的完整测试流程见 [docs/UPDATE_TESTING.md](./docs/UPDATE_TESTING.md)。建议使用 `v0.1.2-beta.0 -> v0.1.2-beta.1` 这类预发布版本验证下载和安装链路，避免影响稳定版用户。
